...
drift_count       = Counter('drift_count',        'Total number of times data drift was detected')
malignant_count   = Counter('malignant_count',    'Total number of malignant predictions')
benign_count      = Counter('benign_count',       'Total number of benign predictions')
...
# ── Start ─────────────────────────────────────────────────────────
if __name__ == "__main__":
    # start_http_server(8000)   # Prometheus metrics server → http://localhost:8080
